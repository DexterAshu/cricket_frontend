...
export const routes: Routes = [
    { path: "", loadComponent: () => import("./component/login/login.component").then((m) => m.LoginComponent) },
    { path: "live-score", loadComponent: () => import("./component/live-score/live-score.component").then((m) => m.LiveScoreComponent) },
    ...
    { path: "register", loadComponent: () => import("./component/signup/signup.component").then((m) => m.SignupComponent) },
